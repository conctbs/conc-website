    ...
    sections: [
      {
        ...
        title: "Short programs built for teams that need practical digital execution",
        description: "This sample page mirrors the frontend programs route and gives editors a reusable way to feature upcoming training offers.",
        primaryButtonText: "Contact Us",
        primaryButtonUrl: "/contact",
        secondaryButtonText: "Read About Us",
        secondaryButtonUrl: "/about",
      ...
      },
      {
        ...
        description: "Select active programs for the main listing page and reuse the same section on campaign or partnership pages.",
        limit: 6,
      ...
      },
      {
        ...
        title: "Need an in-house version for your team?",
        description: "Use the listing page to route organizations into a tailored program conversation.",
