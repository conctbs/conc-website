...
const programs: Program[] = [
  {
    id: 1,
    title: "TU x TDA Co-Certificate Program in Business Data Analytics",
    slug: "tu-x-tda-co-certificate-program-in-business-data-analytics",
    category: "Management Development",
    format: "Certificate Program",
    dateLabel: "7 March - 5 April 2026",
    startsAt: "2026-03-07",
    duration: "61 hours",
    location: "Thammasat Business School (Tha Prachan) and True Digital Park",
    fee: "THB 32,000",
    audience: "ผู้บริหารและบุคคลทั่วไป (ไม่จำเป็นต้องมีพื้นฐาน)",
    summary:
      "หลักสูตรร่วมระหว่างมหาวิทยาลัยธรรมศาสตร์และ True Digital Academy เพื่อพัฒนาความเข้าใจและทักษะพื้นฐานด้านการแสวงหา จัดเตรียม และวิเคราะห์ข้อมูลขนาดใหญ่ ก่อนนำไปประยุกต์ใช้เพื่อการตัดสินใจและกลยุทธ์ทางธุรกิจได้อย่างเหมาะสม",
    tagline: "พัฒนาศักยภาพ ทักษะการวิเคราะห์ข้อมูลขนาดใหญ่ เพื่อนำไปประยุกต์ใช้กับกลยุทธ์ทางธุรกิจ",
    overview: [
      "การเปลี่ยนแปลงทางดิจิทัลและพฤติกรรมการใช้ชีวิตบนโลกออนไลน์ทำให้องค์กรต้องพึ่งพาข้อมูลมากขึ้น ทั้งในการมองภาพตลาด ทำความเข้าใจลูกค้า และตัดสินใจภายใต้สภาพแวดล้อมที่เปลี่ยนแปลงรวดเร็ว",
      "หลักสูตรนี้พัฒนาโดยมหาวิทยาลัยธรรมศาสตร์ร่วมกับ True Digital Academy เพื่อปูพื้นฐานสำคัญด้าน Data Science, Database, SQL, Excel, Tableau และ Python สำหรับผู้ที่ต้องการใช้ข้อมูลอย่างเป็นระบบในบริบทธุรกิจจริง",
      "รูปแบบการเรียนออกแบบให้ผู้เข้าอบรมได้เห็นตั้งแต่แนวคิด เครื่องมือ การทำความสะอาดข้อมูล การวิเคราะห์ และการแปลผล ไปจนถึงการประยุกต์ใช้กับกรณีธุรกิจจริงและการนำเสนอผลงาน",
      "ผู้ที่เข้าเรียนไม่น้อยกว่า 80% ของเวลาเรียนทั้งหมดจะได้รับวุฒิบัตรจากคณะพาณิชยศาสตร์และการบัญชี มหาวิทยาลัยธรรมศาสตร์",
    ],
    outcomes: [
      "เรียนรู้หลักการ แนวคิด ทฤษฎี และเครื่องมือพื้นฐานสำคัญในการวิเคราะห์ข้อมูลขนาดใหญ่เพื่อกำหนดกลยุทธ์ทางธุรกิจ",
      "สามารถประยุกต์ใช้ความรู้ด้านการวิเคราะห์ข้อมูลกับงานและหน่วยงานของตนได้อย่างเหมาะสม",
      "พัฒนาความสามารถในการตีความข้อมูลและนำผลวิเคราะห์ไปใช้เพื่อการตัดสินใจอย่างสร้างสรรค์",
      "ได้แลกเปลี่ยนความรู้ ความคิด และประสบการณ์กับผู้เข้าอบรมท่านอื่นและวิทยากรผู้เชี่ยวชาญ",
    ],
    seats: 40,
    ...
    registrationNote:
      "ปิดรับสมัครแล้ว ผู้เข้าอบรมที่มีเวลาเรียนไม่น้อยกว่า 80% ของเวลาเรียนทั้งหมดจะได้รับวุฒิบัตรจากคณะพาณิชยศาสตร์และการบัญชี มหาวิทยาลัยธรรมศาสตร์ สอบถามข้อมูลเพิ่มเติมได้ที่ CONC Thammasat โทร 09-1119-4503 (คุณธัญลักษณ์) เวลา 08.00 - 16.00 น.",
    coverImage: noMedia,
    gallery: [],
    speakers: [],
    agendaItems: [
      {
        id: 1,
        timeLabel: null,
        title: "กิจกรรมแนะนำตัวเพื่อสร้างเครือข่ายและความสัมพันธ์",
        description: "1 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 2,
        timeLabel: null,
        title: "Introduction to Data Science and its Application",
        description: "3 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 3,
      ...
      },
      {
        id: 4,
        timeLabel: null,
        title: "Marketing: Foundation and Trends",
        description: "3 ชั่วโมง",
        speakerName: null,
      },
      {
      ...
      },
      {
        id: 7,
        timeLabel: null,
        title: "Data Acquisition and Cleaning with SQL",
        description: "3 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 8,
        timeLabel: null,
        title: "Introduction to Excel Basics and Functions",
        description: "3 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 9,
        timeLabel: null,
        title: "Data Analysis and Interpretation with Excel",
        description: "3 ชั่วโมง",
        speakerName: null,
      },
      {
      ...
      },
      {
        id: 12,
        timeLabel: null,
        title: "Basic Text Analytics with Python",
        description: "6 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 13,
        timeLabel: null,
        title: "Real Business Use Case 1-4",
        description: "12 ชั่วโมง",
        speakerName: null,
      },
      {
        id: 14,
        timeLabel: null,
        title: "Project Consulting 1-2",
        description: "6 ชั่วโมง",
        speakerName: null,
      },
      {
    ...
    testimonials: [],
    seo: {
      metaTitle: "TU x TDA Co-Certificate Program in Business Data Analytics",
      metaDescription:
        "หลักสูตรอบรมด้าน Business Data Analytics โดยมหาวิทยาลัยธรรมศาสตร์และ True Digital Academy สำหรับผู้บริหารและบุคคลทั่วไป",
      canonicalUrl: "https://conc.example/programs/tu-x-tda-co-certificate-program-in-business-data-analytics",
      noIndex: false,
      metaImage: null,
    },
  },
